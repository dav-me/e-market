            ...
            <div class="card-body">
              ...
              ?>
                ...
                <tr>
                  ...
                  <td> <span class="badge badge-primary">En Location</span></td>
              	  <td><img src="../../_bx_assoc_imgs_/_bx_assoc_imgs_/<?php echo($key->imgPrcl);?>" style="width:100px"/></td>
                  ...
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" id="<?php echo($key->id);?>" href="#"  onclick="getItemForEditForLease(this.id);">Edit</a>
                        <a class="dropdown-item" href="#" id="<?php echo($key->id);?>"  onclick="getItemForDeleteLese(this.id);">Delete this product</a>
                      </div>
                    </button>
                  </div>
                  </td>
...
<section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">DataTable of Cars <span class="badge badge-warning">En Vente</span></h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle dropdown-icon" data-toggle="dropdown">
                      <span class="sr-only">Toggle Dropdown</span>
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" id="<?php echo($key->id);?>" href="#"  onclick="getItemForEditForSale(this.id);">Edit</a>
                        <a class="dropdown-item" href="#" id="<?php echo($key->id);?>"  onclick="getItemForDeleteSale(this.id);">Delete this product</a>
                      </div>
                    </button>
                  </div>
                  </td>
