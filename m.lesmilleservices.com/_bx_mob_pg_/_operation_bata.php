            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <span>Véhicules interchageables</span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    <div class="product-list">
                        <div class="row" id="product_listing">
                            <?php  
                                // $indPrd = new Product();
                                $srt = 9; $pr = _onLoadProductBata($bdd); if($pr != null) { 
                            ...
                            ?>  
                        <a href="?page=_product_bata&_prd_get_cat_=<?php echo($indPrd->model)?>&_idProduct_=<?php echo($indPrd->id);?>" class="">
                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        ...
                                        <ul class="d-none">
                                            ...
                                            <li class="quick-view">
                                                <a href="?page=_product_bata&_idProduct_=<?php echo($indPrd->id);?>&_prd_get_cat_=<?php echo(md5($indPrd->id));?>">+ Détail car</a>
                                            </li>
                                            <li class="w-icon"><a href="#"><i class="fa fa-random"></i></a></li>
                                        </ul>
                                    </div>
                                    <div class="pi-text p-2 border shadow">
                                        <div class="catagory-name"><?php echo($indPrd->marque); ?>&nbsp;<b><?php echo($indPrd->model); ?></b></div>
                                        <div class="product-price h-25" style="font-size:10px;padding:2px 2px">
                                            <?php echo($indPrd->description); ?>
                                            <!-- <span>$21000.00</span> -->
                                        </div>
                                    </div>
                                </div>
