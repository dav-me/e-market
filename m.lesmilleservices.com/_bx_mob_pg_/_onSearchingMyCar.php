                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    ...
                    <div class="product-list">
                        <div class="row" id="product_listing">
                            <?php  
                                // $indPrd = new Product();
                                $srt = 9; $pr = _onLookingAtAll(trim($_GET['get_it']),$bdd); 
                                ...
                                <div class="product-item">
                                    <div class="pi-pic make_shadow">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view">
   <a href="?page=_product&_prd_get_cat_=<?php echo($indPrd->categorie)?>&_idProduct_=<?php echo($indPrd->id);?>">+ Détail car</a>
                                            </li>
                        ...
                        ?>    
                                ...
                                <div class="alert alert-default">
                                     <span class="fa fa-warning">Aucun resultat n'a été trouver pour : <?php echo($_GET['get_it']); ?></span>
                                </div>
