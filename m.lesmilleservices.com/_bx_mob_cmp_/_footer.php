<div class="shadow p-1 mb-4 col-3" style="position:fixed;float:right;right:0px;z-index:40000;line-height:60px;text-align:center;border-radius:50% 0 0 50%">
    <!-- <div class="row">
      <div class="col-lg-6"></div>
      <div class="col-lg-6"></div>
    </div> -->
    <div class="w-100 circle border overflow-auto">
        <img src="../_bx_assoc_imgs_/_bx_banners_/thumb.png" alt="Assistant" class="w-100 h-100">
    </div>
</div>
