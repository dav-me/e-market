<?php
    ...
    <div class="w-100 p-2 bg-light border mt-2">
      <div class="col-lg p-2 underlined cursor-p" id="pull-d-nav-marq">
        ...
        <nav class="nav flex-column mb-5 hd-sm" id="nav-marq">
    <?php
   ...
   <!-- end section 2 -->
   <div class="w-100 px-0 mt-4 bg-primary stickyy">
   <div class="mt-1 text-dark hd-sm border bg-light p-2 w-100"><b>Soyez rassurez vous êtes au bon endroit</b></div>
   <div class="mt-3 hd-sm"><img src="_bx_assoc_imgs_/_images_pub/rretrouver.jpg" alt="L1000" title="Visitez : https://lesmilleservices.com/"></div>
   <?php #@include('left_pub.html'); ?>
   <div class="hd-sm"><?php @include('_bx_body_/pub.php'); ?></div> <br>
   <?php #@include('_autres_pub.php'); ?>
   <div class="mt-3 hd-sm"><img src="_bx_assoc_imgs_/_images_pub/suiter.jpg" alt="L1000" title="Visitez : https://lesmilleservices.com/"></div>
    </div>
   </div>
    <!-- <div class="col-lg-3 my-4">
