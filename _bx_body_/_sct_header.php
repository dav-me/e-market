    ...
    <header class="header-section" >
        <div class="col-lg-12 bg-dark text-center">
          <small class="text-white"><b>La réference N<sup style="text-decoration: underline">o</sup><strong>1</strong> de vente et location des véhicules en RDC</b></small>
        </div>
            ...
            <div class="row">
               ...
               <div class="col-lg-3">
                 <div class="col-lg-12">
                   ...
                   <p>Importateur des véhicules</p><br>
                   <?php    
		        ...
		        echo('<small><span class="fa fa-clock-o mr-1"></span>Heure de <strong>RDC / Goma</strong>:&nbsp;<b class="badge badge-light p-1 border float-right"></small>' .$gmdate.'</b><br>');
		        $date = gmdate('H:i:s');
                echo('<small><span class="fa fa-clock-o mr-1"></span>Temp Universel :&nbsp;<b class="badge badge-light p-1 border float-right mt-1"></small>' .$date.'</b>');
              	   ?>
                   <p id="date-content" class="d-none"></p> 
                 </div>
               </div>
               <!--  -->
               <!--  -->
                   ...
                   <div class="col-lg-12">
                     <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control w-75 pill-l" id="_keySrch_" name="_keySrch_" placeholder="Entre le nom du véhicule ...">
                            <span class="input-group-append">
                                <button type="button" class="btn btn-primary btn-flat pill-r" id="_btn_adv_srch_">
           ...
           <div class="container">
                <div class="col-sm-2 styckyimg addaptator">
                    <a class="navbar-brand bg-dark text-center justify-content-center w-100 shadow" href="?page=home">
                        ...
                        <img src="./_bx_assoc_imgs_/_bx_banners_/a2.jpg" alt="logo header" title="L1000" class="w-75">
                    </a>
                </div>
                <!-- form search -->
                ...
                <nav class="collapse navbar-collapse overflow-hidden pl-cst-25" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item-cst pr-5 text-white text-uppercase  hov"><a href="?page=home"> <span class="fa fa-home mr-2"></span>&nbsp;acceuil</a></li>
                        ...
                        <li class="nav-item-cst pr-5 text-white text-uppercase  cab-down hov">
                            ...
                            <div class="dropdown-cntnt position-absolute py-2 bg-dark shadow">
                                <a class="text-white dropdown-item p-2" href="?page=_signIn">Connexion</a>
                                <a class="text-white dropdown-item p-2" href="?page=_signUp">Créer un compte</a>
                                <a class="text-white dropdown-item p-2" href="?page=_contact">contact</a>
                                <!-- <b class="cab-down">
                                    <a class="text-white dropdown-item p-2" href="?page=_contact">autres</a>
                                    <div class="dropdown-cntnt position-absolute py-2 bg-primary shadow">
                                        <a href="">1</a>
                                        <a href="">1</a>
                                        <a href="">1</a>
                                        <a href="">1</a>
                    ...
                    <div class="login-form">
                        <form id="formConn-h">
                            ...
                            <div class="group-input">
                                <label for="username-h">Numero de telephone ou E-mail</label>
                                <input type="text" id="username-h" name="username_h" placeholder="ex: mail@kbx.domain">
                            </div>
                            <div class="group-input">
                                <label for="pass-h">Mot de passe</label>
                                <input type="password" id="pass-h" name="pass_h">
                                <!--<b class="fa fa-eye"></b>-->
                            ...
                            <div class="group-input gi-check">
                                <div class="gi-more">
                                    ...
                                    Enregistrer le mot de passe
                                        <input type="checkbox" id="save-pass-h">
                            ...
                            <div class="switch-login">
                                ...
                                <p class="text-danger mt-2" id="tooltip-h"></p>
                                    
                            </div> 
                            <!-- <button type="button" class="site-btn login-btn text-white" id="btn-connx-h">
                                Connexion
                            </button> -->
                        </form>
                    </div>
