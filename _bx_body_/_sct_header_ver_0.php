...
.sticky {
  ...
  z-index:2000;
    ...
    <header class="header-section shadow">
        ...
        <div class="nav-item"  id="menuFixed">
            <div class="container">
                ...
                <nav class="nav-menu mobile-menu">
                    <ul >
                        <li class="active_h" id="haut"><a href="?page=home">Home</a></li>
                        ...
                        <li class="active_b"><a href="?page=_operation_bata">Bata</a></li>
                        ...
                        <li class="active_p"><a href="#">Pages</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="?page=_signUp">Créer un compte</a></li>
                    ...
                    <div class="login-form">
                        <form id="formConn-h">
                            ...
                            <div class="switch-login">
                                ...
                                <p class="text-danger mt-2" id="tooltip-h">
    ...
    </div><div style="floate:right;"><?php // include('_bx_body_/pub.php'); ?></div>
