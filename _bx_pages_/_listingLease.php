<style>
 ...
 $cat = 0;
 $categorie  = $_GET['_categ'] ?? '0a243644fa3d0ceb0dd57dea2f3cd99f'; #hash 95_cat
 switch($categorie){case 'e18305641ab8984e98815621ada7477e': $cat = 95;break; case '0a243644fa3d0ceb0dd57dea2f3cd99f': $cat = 84; break; default : $cat = 84;break;}
 $no_elem_per_page = 16;
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="product-show-option ml-0 pl-0 mb-0 mt-2 px-3 border bg-light mt-4 mb-2">
                        <div class="row pl-0 ml-0">
                            <div class="col-lg-7 col-md-7 ml-0 pl-0">
                    ...
                    <div class="product-list bg-light border px-3">
                        <div class="row" id="product_listing">
                         <?php 
				 if(!empty($data)){
				 $badge = ('<div class="badge badge-primary shadow"><b>En Location</b></div>');
...
<nav aria-label="Page navigation example" class="col-lg-12">
  <ul class="pagination pagination-md justify-content-center">
    ...
    <!-- --------------------------------------- -->
      ...
      <a href="?page=_listingLease&tabIndx=<?php echo($prevpage)?>&_categ=0a243644fa3d0ceb0dd57dea2f3cd99f" class="page-link" aria-label="Next" id="btn-prev">
    ...
    <!-- ------------------------------------------ -->
     <li class="page-item disabled" id="prev">
      <a href="?page=_listingLease&tabIndx=<?php echo($prevpage)?>&_categ=<?php echo($cat) ?>" class="page-link" aria-label="Next" id="btn-prev">
        <span aria-hidden="true">&laquo;</span>
        <span class="sr-only">Prev</span>
      </a>
    </li>
    ...
    <?php for($i = 0; $i < $total_page; $i++){ ?>
        <li class="page-item pa-ge" id="page_<?php echo($i+1); ?>"><a href="?page=_listingLease&tabIndx=<?php echo($i+1)?>&_categ=0a243644fa3d0ceb0dd57dea2f3cd99f" class="page-link pa-ge" id="<?php echo($i+1); ?>"><?php echo($i+1); ?></a></li>   
   <?php } ?>
    <?php if($nextpage === $total_page) {?>
    <!-- --------------------------------------------- || -- -->
      <li class="page-item disabled" id="next">
      <a  href="?page=_listingLease&tabIndx=<?php echo($nextpage)?>&_categ=<?php echo($cat) ?>" class="page-link" aria-label="Next" id="btn-next">
    ...
    <!-- ------------------------------------------------- -->
      ...
      <a  href="?page=_listingLease&tabIndx=<?php echo($nextpage)?>&_categ=0a243644fa3d0ceb0dd57dea2f3cd99f" class="page-link" aria-label="Next" id="btn-next">
        <span aria-hidden="true">&raquo;</span>
        <span class="sr-only">Next</span>
      </a>
    </li>
