<style>
 ...
 $plageright = ($shown + $no_elem_per_page * ($pageno - 1));
    ...
    <section class="product-shop spad pt-0" id="items">
        <div class="container">
            <div class="row">
		<?php include('./_bx_body_/_sct_left_menu.php'); ?>             
                <div class="col-lg-9 mt-4 p-2">
                <div class="col-lg-12 mb-3 bg-light border mt-0"><?php include('./_bx_body_/_sct_annonce.php') ?></div>
                    <div class="product-show-option bg-light border p-2">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right px-3">
                    ...
                    <div class="product-list bg-light border p-2 mt-1">
